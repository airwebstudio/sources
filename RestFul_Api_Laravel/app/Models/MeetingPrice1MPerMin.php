 ...
 * )
 */
class MeetingPrice1MPerMin extends Model
{
	protected $table = 'meeting_price_1_m_per_min';
    ...
    {
        return $this->hasMany(MeetingDynamicalPrice::class, 'meeting_hash', 'hash');
    }
}
