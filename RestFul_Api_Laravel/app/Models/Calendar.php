 ...
 *     @OA\Property(property="participants", type="array", @OA\Items(ref="#/components/schemas/CalendarParticipant")),
 * )
 */
class Calendar extends Model
{
    ...
    public function addParticipant($user_id){
        return CalendarParticipant::create([
            'calendar_id' => $this->id,
            'user_id' => $user_id
        ]);
    }
    ...
    {
        return $this->hasMany(CalendarParticipant::class);
    }
