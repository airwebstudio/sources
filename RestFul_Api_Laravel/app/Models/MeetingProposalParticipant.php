...
/**
 * @OA\Schema(
 *     title="MeetingProposalParticipant",
 ...
 *     @OA\Property(property="meeting_proposal_id", type="string", format="meeting_proposal_id", example="1"),
 ...
 * )
 */
class MeetingProposalParticipant extends Model
{
    use HasFactory;

    protected $fillable = [
        'meeting_id', 'meeting_proposal_id', 'user_id',
    ];
    ...
    public function meetingProposal()
    {
        return $this->belongsTo(MeetingProposal::class);
    }
